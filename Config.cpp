...
void CConfig::Setup()
{
			...
			SetupValue(Options.Ragebot.HvH.bResolver, 0, "Rage_HvH", "bResolver");
			...
			SetupValue(Options.Legitbot.Aimbot.Pistols.bEnableLegitBacktrack, false, "Legitbot_Aimbot_Pistols", "bEnableLegitBacktrack");
			...
			SetupValue(Options.Legitbot.Aimbot.Rifles.bEnableLegitBacktrack, false, "Legitbot_Aimbot_Rifles", "bEnableLegitBacktrack");
			...
			SetupValue(Options.Legitbot.Aimbot.Snipers.bEnableLegitBacktrack, false, "Legitbot_Aimbot_Snipers", "bEnableLegitBacktrack");
			...
			SetupValue(Options.Legitbot.Aimbot.Shotguns.bEnableLegitBacktrack, false, "Legitbot_Aimbot_Shotguns", "bEnableLegitBacktrack");
			...
			SetupValue(Options.Legitbot.Aimbot.Smgs.bEnableLegitBacktrack, false, "Legitbot_Aimbot_Smgs", "bEnableLegitBacktrack");
			...
			SetupValue(Options.Legitbot.Aimbot.Heavy.bEnableLegitBacktrack, false, "Legitbot_Aimbot_Heavy", "bEnableLegitBacktrack");
			...
			SetupValue(Options.Visuals.VisualsMisc.bBackTrackDot, false, "Visuals_VisualsMisc", "bBackTrackDot");
